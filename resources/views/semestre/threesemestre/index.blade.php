@extends('layouts.app')
<title>TERCER SEMESTRE   @yield('title')</title>
@section('content')
<div class="">
    <div class="row justify-content-center">
        ...
        {{-- Color Azul Oscuro #01458E --}}
            <a href="{{url('semestre/threesemestre/create')}}" class="btn btn-success">
            ...
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Lista de Notas <b><u>TERCER SEMESTRE</u></b></li>
                </ol>
            </nav>
         {{-- Tabla --}}
            <table class="table table-inverse table-striped table-bordered table-responsive">
                ...
                <tbody>
                    ...
                    <tr align="center">
                        ...
                        <td>
                            {{-- Boton de editar --}}
                            <a href="{{ url('semestre/threesemestre/'.$one->id.'/edit') }}" class="btn btn-indigo btn-sm"> 
                                <i class="fa fa-pen"></i> 
                            </a>
                            {{-- Botono de eliminar con seguridad--}}
                            <form action="{{ url('semestre/threesemestre/'.$one->id) }}" method="post" style="display: inline-block;">
                                @csrf
                                @method('DELETE')
