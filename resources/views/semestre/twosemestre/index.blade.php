...
<div class="">
    <div class="row justify-content-center">
        ...
        {{-- Color Azul Oscuro #01458E --}}
            <a href="{{url('semestre/twosemestre/create')}}" class="btn btn-success">
            ...
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Lista de Notas <b><u>SEGUNDO SEMESTRE</u></b></li>
                </ol>
            </nav>
         {{-- Tabla --}}
            <table class="table table-inverse table-striped table-bordered table-responsive">
                ...
                <tbody>
                    ...
                    <tr align="center">
                        ...
                        <td>
                            {{-- Boton de buscar --}}
                            {{-- <a href="{{ url('semestre/onesemestre/'.$one->id) }}" class="btn btn-indigo btn-sm"> 
                                <i class="fa fa-search"></i> 
                            </a> --}}
                            {{-- Boton de editar --}}
                            <a href="{{ url('semestre/twosemestre/'.$one->id.'/edit') }}" class="btn btn-indigo btn-sm"> 
                                <i class="fa fa-pen"></i> 
                            </a>
                            {{-- Botono de eliminar con seguridad--}}
                            <form action="{{ url('semestre/twosemestre/'.$one->id) }}" method="post" style="display: inline-block;">
                                @csrf
                                @method('DELETE')
