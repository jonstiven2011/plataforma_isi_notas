    ...
    <div class="row">
        ...
        <div class="col-md-8 offset-md-2">
            ...
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('semestre/twosemestre') }}">Lista de Notas segundo semestre</a></li>
                <li class="breadcrumb-item active" aria-current="page">Editanto Alumno</li>
                </ol>
            </nav>
        <form action="{{url('semestre/twosemestre/'.$semestre->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
