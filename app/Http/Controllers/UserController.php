...
{   
    ...
    public function index()
    {
        ...
        return view('users.index')->with('users',$users)->with("cursos",$cursos);
    }
    ...
    {   
        ...
        //dd("Form Create");
        $cursos = Curso::all();
        return view('users.create')->with("cursos",$cursos);
    }
    ...
    public function store(UserRequest $request)
    {
        ...
        $user->curso_1      = $request->curso_1;
        $user->curso_2      = $request->curso_2;
        $user->curso_3      = $request->curso_3;
    ...
    public function show($id)
    {
        ...
        $cursos = Curso::all();
        $user = User::find($id);
        return view('users.show')->with('user',$user)->with('cursos',$cursos);
    }
    ...
    public function edit($id)
    {
        ...
        $cursos = Curso::all();
        $user = User::find($id);
        return view('users.edit')->with('user', $user)->with('cursos',$cursos);    
    }
